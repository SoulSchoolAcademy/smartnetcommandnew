...
export default function Home(){
  return (
    <div className="container">
      ...
      <section><div className="tile">Activity Stream: [Demo] Initial skeleton commit</div></section>
      <section style={{marginTop:20}}><div className="tile"><b>Deploy Center:</b> Last Deployment Demo v0.1 · Rollback</div></section>
